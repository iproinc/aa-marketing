...
const IndexPage = () => (
  <Layout>
    <Seo title="Home" />
    <section className="pt-40 h-full min-h-[700px] bg-cover bg-bottom flex overflow-hidden" style={{ backgroundImage: `url(${BGimage})` }}>
      <div className="max-w-6xl mx-auto flex flex-row justify-between items-center">
        <div className="w-full max-w-[635px] gap-7 flex flex-col items-start">
          <h1 className="text-5xl font-bold leading-tight drop-shadow-sm">Facebook Ads Insights <br /> For eCommerce Advertisers</h1>
          <p className="text-xl font-medium">Eliminate The Guesswork And Be Data-Informed For All Your ROI-Optimizing Decisions</p>
          <div>
            <a className="rounded bg-[#0083FC] font-semibold text-xl text-white px-4 py-2 inline-block mb-3" href="https://app.adtrics.com/user/sign_up">Start Your Free Trial Now</a>
            <p className="text-sm">7-Day Free Trial. No Credit Card Required. Cancel Anytime.</p>
          </div>
        </div>
        <div className="mr-[-388px]">
          <StaticImage className="w-[860px]" src='../images/home/header-graphic.png' width={860} alt="header graphic"/>
        </div>
      </div>
    </section>
    ...
    <section className="bg-white py-16">
      <div className="max-w-6xl mx-auto">
        <div className="max-w-xl mx-auto text-center flex flex-col items-center gap-6 px-4 mb-14">
          <p className="font-medium text-mariner-500 text-2xl">Introducing Adtrics</p>
          <div className="border-b-4 border-mariner-100 w-24"></div>
          <p className="font-bold text-4xl mb-2">Your Personal Ad Analyst Without The 5-Figure Salary</p>
        ...
        <div className="max-w-6xl mx-auto flex flex-col items-center gap-12 px-4">
          ...
          <div className="w-full grid grid-cols-4 gap-7">
            {suitableBusinesses.map((business, i) => (
              <div key={i} className="rounded border border-mariner-100 p-6 pt-8 leading-loose relative">
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-36">
        <div className="flex flex-row justify-between items-center">
          <div className="w-1/2 flex flex-col gap-6 p-6">
            <p className="font-medium text-2xl">Facebook A.I. Analyzer</p>
        ...
        <div className="flex flex-row-reverse justify-between items-center">
          <div className="w-1/2 flex flex-col gap-6 p-6 lg:pl-36">
            <p className="font-medium text-2xl">Facebook Integration</p>
        ...
        <div className="flex flex-row justify-between items-center">
          <div className="w-1/2 flex flex-col gap-6 p-6">
            <p className="font-medium text-2xl">Unlimited Campaign Analysis </p>
    ...
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto">
        <div className="max-w-xl mx-auto text-center flex flex-col items-center gap-6 mb-14">
          <p className="font-medium text-mariner-500 text-2xl">Discover Adtrics In Action</p>
          <div className="border-b-4 border-mariner-100 w-24"></div>
          <p className="font-bold text-4xl mb-2">Converting Your Facebook Ads Data Into Actionable Insights</p>
        </div>
        <div className="w-full mx-auto flex flex-col items-center gap-12 px-4">
          <div className="w-full grid grid-cols-3 gap-7">
            {steps.map((step, i) => (
              <div key={i} className="flex flex-col gap-6 items-center p-4 text-center">
