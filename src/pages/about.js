  ...
  return (
    <Layout>
      ...
      <section className="mb-12 lg:mb-24">
        <div className="max-w-6xl w-full mx-auto grid grid-rows-2 lg:grid-cols-12 gap-6 px-4">
          <div className="relative col-span-6 p-8 lg:p-12 rounded-2xl overflow-hidden ring-4 ring-white ring-inset ring-opacity-50 bg-gradient-to-br from-[#fff7c980] to-[#ffc58780]">
            <p className="font-bold text-4xl lg:text-6xl leading-tight mb-6">The Story Lies In The Data </p>
            ...
            <StaticImage className="absolute top-[-100px] right-[-500px] transform rotate-45 mix-blend-color-dodge z-10" src="../images/graphic-rect-2.png" alt="Rectangle Asset" width={516} height={516} />
          </div>
          <div className="relative col-span-6 p-8 lg:p-12 rounded-2xl overflow-hidden ring-4 ring-white ring-inset ring-opacity-50 bg-gradient-to-br from-[#dbf7f380] to-[#929de780]">
            <p className="font-bold text-4xl lg:text-6xl leading-tight mb-6">Our Mission: Simplifying Data Analysis For Advertisers</p>
            <div className="relative leading-relaxed text-san-marino-900 z-20">
