...
const Header = ({ siteTitle }) => {
  ...
  return (
    <header className={`fixed w-full top-0 z-50 ${scrollTop > menuBGTrigger || 90 ? "bg-mariner-50 backdrop-filter backdrop-blur-lg" : "bg-transparent"} transition-all ease-in-out duration-500 bg-opacity-90`}>
